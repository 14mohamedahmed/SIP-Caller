  ...
  void _loadSettings() async {
    ...
    setState(() {
      _wsUriController.text =
          _preferences.getString('ws_uri') ?? 'ws://10.10.0.150:8088/ws';
      _sipUriController.text =
          _preferences.getString('sip_uri') ?? '105@10.10.0.150:8089';
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'MOHAMED';
      _passwordController.text =
          _preferences.getString('password') ?? 'mahmed@105';
      _authorizationUserController.text =
          _preferences.getString('auth_user') ?? '105';
    });
  }
