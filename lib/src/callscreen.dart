...
class CallScreenWidget extends StatefulWidget {
  ...
  final Call? _call;
  final RTCVideoRenderer? _localRenderer, _remoteRenderer;

  CallScreenWidget(
      this._helper, this._call, this._localRenderer, this._remoteRenderer,
      {Key? key})
      : super(key: key);
...
class _MyCallScreenWidget extends State<CallScreenWidget>
  ...
  void callStateChanged(Call call, CallState callState) {
    ...
    print("callState.cause ${callState.cause}");
    print("callState.state ${callState.state}");
  ...
  void _handelStreams(CallState event) async {
    ...
    print("event.originator ${event.originator}");
